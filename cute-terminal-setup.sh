...
# ----------------------
# 5. Install Dependencies Based on Distro
# ----------------------

echo "📦 Installing required packages..."

# Try detecting package manager
...
rm -f FiraCode.zip FiraCode/*Windows* FiraCode/*macOS*
...
# ----------------------
# 9. Backup and Update Shell RC File
# ----------------------
